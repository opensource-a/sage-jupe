...
sed -i  "s/#gluetable1/$table1/g" $notebookPath/$originalnotebookName_parameters.yaml
sed -i  "s/#gluetable2/$table2/g" $notebookPath/$originalnotebookName_parameters.yaml
